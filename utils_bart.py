...
def compute_metrics(pred, processor: TrOCRProcessor, model_config):
    labels_ids = pred.label_ids
    pred_ids = pred.predictions
    labels_ids[labels_ids == -100] = model_config.decoder.pad_token_id
...
class DataCollatorForOCR:
    ...
    def __call__(self, features: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if DatasetColumns.labels in features[0]:
            texts = [feature[DatasetColumns.labels] + "</s>" for feature in features]
